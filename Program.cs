...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!dbContext.Blogs.Any())
    {
        dbContext.Blogs.AddRange(
            new Blog { Id = 1, title = "Portfolio Website", summary = "My personal portfolio site.", imageUrl = "/images/portfolio.png", slug = "Blog-1", author = "Abhishek Hanamagond", imageHint = "", publishedAt=DateTime.Now, skill = ["React", "NextJS", "Performance"], content="Content of blog add here" }
        );
        dbContext.SaveChanges();
    }
}
